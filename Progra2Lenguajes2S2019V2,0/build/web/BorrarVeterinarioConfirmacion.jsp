...
<html>
    ...
    <body >
        ...
        <%
            ...
            borrado = resultado.borrarVeterinario(id);
            
            if(borrado){
                mensaje = "El veterinario con la cédula " + id + " ha sido eliminado.";
            }else{
                mensaje = "El veterinario con la cédula " + id + " no ha podido ser eliminado.";
            }
