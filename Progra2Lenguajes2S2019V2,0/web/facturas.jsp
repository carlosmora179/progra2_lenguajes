...
<html>
    ...
    <body >
        ...
        <button type="text" class="btn btn-primary mb-2" 
                onclick="window.location='ConsultaFacturasFecha.jsp'">Consultar Facturas por Fecha</button>
                <button type="text" class="btn btn-primary mb-2" 
                onclick="window.location='ConsultaFacturaCliente.jsp'">Consultar Facturas por Dueño</button>
