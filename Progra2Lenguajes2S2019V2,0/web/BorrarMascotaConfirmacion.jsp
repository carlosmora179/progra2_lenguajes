...
<html>
    ...
    <body >
        ...
        <%
            ...
            Integer id = Integer.parseInt(request.getParameter("codigo_mascota"));
            
            borrado = resultado.borrarMascota(id);
            
            if(borrado){
                mensaje = "La mascota con el código " + id + " ha sido eliminado.";
            }else{
                mensaje = "La mascota con el código " + id + " no ha podido ser eliminado.";
            }
